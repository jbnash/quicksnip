...
class HelpWindowController: NSWindowController {
    ...
    private func buildHelpText() -> NSAttributedString {
        ...
        // ── Menu bar position ──
        heading("Moving the ⚡ icon in the menu bar")
        body("macOS decides the default position of menu bar icons, and on MacBooks with a notch the icon can end up hidden. To move it:")
        body("  Hold ⌘ (Command) and drag the ⚡ icon to any position in the menu bar. The new position sticks permanently.")
        body("  Tip: drag it all the way to the right, next to the clock, so it's always visible and easy to reach.")
        body("  If the icon is hidden and you can't drag it: open QuickSnip again from your Applications folder — it will open the Snippets window directly.")
